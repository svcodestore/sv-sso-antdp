export default {
  'pages.layouts.userLayout.title': 'Login once, active every application.',
  'pages.login.accountLogin.tab': 'Account Login',
  'pages.login.accountLogin.title': 'Log in SV',
  ...
  'pages.admin.subPage.title': 'This page can only be viewed by Dashboard',
